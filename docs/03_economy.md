...
Equipment is bought, looted, or crafted (late game). It has:
- A **slot** (weapon, armour, accessory ×2, tool)
- **Stat modifiers**
- A **durability** rating — equipment degrades in dungeons and must be repaired or replaced
- A **class restriction** (some items require STR threshold, etc.)
